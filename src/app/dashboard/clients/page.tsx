...
import { Plus, Search, Download, Users, ArrowRight, TrendingUp, DollarSign, AlertCircle, Phone, ArrowUpDown } from 'lucide-react';
          ...
          {filteredClients.map((client, i) => (
            <Link key={client.id} href={`/dashboard/clients/${client.id}`} className="block">
              <div className={`glass-card rounded-2xl p-6 hover-lift cursor-pointer group opacity-0 ${mounted ? 'animate-fade-up' : ''}`} style={{ animationDelay: `${i * 50}ms` }}>
                ...
                <p className="text-gray-400 text-sm mb-4">{client.telefone ? formatPhone(client.telefone) : 'Sem telefone'}</p>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-400">{client.telefone ? formatPhone(client.telefone) : 'Sem telefone'}</p>
                    </div>
                  </div>
