export const verificationEmailTemplate = (name: string, verifyUrl: string) => `
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
        ...
        <table width="560" cellpadding="0" cellspacing="0" style="background-color: #0a0a0a; border-radius: 16px; border: 1px solid #1f1f1f; padding: 40px;">
          ...
          <tr>
            <td style="text-align: center; padding-bottom: 24px;">
              <h1 style="color: #ffffff; font-size: 28px; font-weight: 700; margin: 0 0 8px 0;">Bem-vindo ao VenceJa!</h1>
              <p style="color: #10b981; font-size: 16px; font-weight: 500; margin: 0;">Confirme seu email para continuar</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding-bottom: 24px;">
              ...
              <p style="color: #a3a3a3; font-size: 15px; line-height: 24px; margin: 0;">
                Você está a um passo de ativar sua conta no <strong style="color: #10b981;">VenceJa</strong>. Para começar a gerenciar suas cobranças de forma inteligente, confirme seu email:
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="text-align: center; padding-bottom: 24px;">
              <a href="${verifyUrl}" style="display: inline-block; background-color: #10b981; color: #000000; font-size: 16px; font-weight: 600; text-decoration: none; padding: 16px 40px; border-radius: 12px;">Confirmar Email</a>
            </td>
          </tr>
          ...
          <tr>
            <td style="text-align: center; padding-bottom: 24px;">
              ...
              <a href="${verifyUrl}" style="color: #10b981; font-size: 12px; text-decoration: underline; word-break: break-all;">${verifyUrl}</a>
            </td>
          </tr>
          ...
          <tr>
            <td style="border-top: 1px solid #262626; padding-top: 24px;">
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background-color: rgba(251, 191, 36, 0.1); border-radius: 12px; padding: 16px;">
                <tr>
                  <td style="text-align: center;">
                    <p style="color: #fbbf24; font-size: 14px; font-weight: 600; margin: 0 0 8px 0;">⚡ Importante:</p>
